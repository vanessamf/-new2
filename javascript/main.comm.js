...
$(document).ready(function() {
	$("#menu_header").load("/business-new2/common/header.html");
	$("#nav").load("/business-new2/common/nav.html");
});
...
//  $(".tab-pane.active .tab-form").outerHeight()；
var btnHeight=$(".advanced-setup .page-btn").outerHeight();
var panPadding=($(".menu-container .tab-content>.tab-pane").outerWidth()-$(".menu-container .tab-content>.tab-pane").width())/2;
var scrollHeight=$(".tab-pane.active .tab-form").length>=1?$(".tab-pane.active .tab-form").get(0).scrollHeight:"";
	if(scrollHeight+btnHeight> $(".tab-content").height()-panPadding) {
		$(".menu-container .tab-content>.tab-pane.active").css("height", "100%");
		$(".menu-container .tab-content>.tab-pane.active").siblings(".tab-pane").css("height", "fit-content");
	} else {
