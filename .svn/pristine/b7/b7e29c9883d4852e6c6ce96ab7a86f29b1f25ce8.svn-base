    ...
    BootstrapPaginator.prototype = {
        ...
        render: function() {
            var containerClass = this.getValueFromOption(this.options.containerClass, this.$element)
                ...
                , alignment = this.options.alignment || "right"
                , pages = this.getPages()
        ...
        getPages: function() {
            var totalPages = this.totalPages
                ...
                , i = 0
                , counter = 0;
            for (pageStart = 1 > pageStart ? 1 : pageStart,
                     i = pageStart,
                     counter = 0; counter < this.numberOfPages && totalPages >= i; i += 1,
                     counter += 1)
                output.push(i);
