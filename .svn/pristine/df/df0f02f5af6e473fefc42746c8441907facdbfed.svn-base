/**
 * Created by chaoyue on 2017/12/1.
 */
...
(function($) {
    $.fn.lavaLamp = function(o) {
        ...
        return this.each(function() {
            ...
            var b = $(this),
                noop = function() {},
                $back = $('<li class="back slider"><div class="left"></div></li>').appendTo(b),
                $li = $("li", this),
            ...
            $li.not(".back").hover(
                function(e){
                    var $child = $(this)
                    if($child.parent().hasClass('dropdown-menu')) return;
                    move(this)
                }, noop);
            ...
            $li.click(function(e) {
                ...
                // 获取较大值
                buttonHeight = buttonWidth = (buttonWidth >= buttonHeight) ? buttonWidth:buttonHeight
                ...
                if( $this.parent().hasClass('dropdown-menu')) return
                else{
                    setCurr(this);
                    return o.click.apply(this, [e, this])
                }
